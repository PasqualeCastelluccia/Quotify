...
import { ArrowLeft, Upload, FileSpreadsheet, AlertTriangle } from 'lucide-react'
...
export default function ImportProductsFromFile() {
        ...
        <>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Seleziona quale colonna dell'Excel corrisponde a ogni campo del prodotto
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={columnMapping.code?.split('|')[0] || ''}
                    onValueChange={(value) => updateMapping('code', value)}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={columnMapping.price?.split('|')[0] || ''}
                    onValueChange={(value) => updateMapping('price', value)}
                  >
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="-- Seleziona colonna --" />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={columnMapping.description?.split('|')[0] || ''}
                    onValueChange={(value) => updateMapping('description', value)}
                  >
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="-- Seleziona colonna --" />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={columnMapping.measure?.split('|')[0] || ''}
                    onValueChange={(value) => updateMapping('measure', value)}
                  >
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="-- Seleziona colonna --" />
                    </SelectTrigger>
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button onClick={handleImport} disabled={!columnMapping.code || !columnMapping.price || isLoading}>
              Importa Prodotti
            </Button>
          </div>
        </>
