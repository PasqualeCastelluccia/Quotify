...
import type { CustomerFormData } from '@/app/types/customer'
...
export default function CreateCustomer() {
  ...
  const handleSubmit = async (data: CustomerFormData) => {
    try {
      ...
      const result = await window.conveyor.customers.create(data)
    ...
    <div className="flex flex-1 flex-col gap-6 p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Inserisci i dettagli del cliente. I campi contrassegnati con * sono obbligatori.
          </CardDescription>
        </CardHeader>
        <CardContent>
