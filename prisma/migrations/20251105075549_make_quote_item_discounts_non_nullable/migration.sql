...
INSERT INTO "new_quote_items" ("code", "createdAt", "description", "discount1", "discount2", "discount3", "id", "lineTotal", "measure", "netLineTotal", "netUnitPrice", "ordering", "productId", "quantity", "quoteId", "unit", "unitPrice", "updatedAt", "vatAmount", "vatRate") SELECT "code", "createdAt", "description", coalesce("discount1", 0) AS "discount1", coalesce("discount2", 0) AS "discount2", coalesce("discount3", 0) AS "discount3", "id", "lineTotal", "measure", "netLineTotal", "netUnitPrice", "ordering", "productId", "quantity", "quoteId", "unit", "unitPrice", "updatedAt", "vatAmount", "vatRate" FROM "quote_items";
